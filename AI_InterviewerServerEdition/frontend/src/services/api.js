...
export const interviewsAPI = {
  ...
  // 获取主题的所有访谈
  getInterviewsByTopic(topicId) {
    return apiClient.get(`/interviews/topic/${topicId}`);
  },

  // 确认进入最后一个问题
  confirmLastQuestion(id) {
    return apiClient.post(`/interviews/${id}/confirm-last`);
  }
};
...
export const summariesAPI = {
  ...
  // 删除总结
  deleteSummary(interviewId) {
    return apiClient.delete(`/summaries/${interviewId}`);
  }
};
